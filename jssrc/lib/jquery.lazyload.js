...
(function($){
    $.fn.lazyload = function(options) {
        ...
        $(document).bind("keyup", function(event){
            ...
            如果按下的是END键就全部加载
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            if(event.which === 35 && imgObjectArray) {
    ...
    $.fn.lazyload.filterCache = function(elements, opts) {
        ...
        if($(elements).size() === 0 ) return lazyImgArray ;
        $(elements).each(function(index, element){
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            如果元素不可见而且允许忽略就忽略
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            if( ! $(element).is(":visible") && opts.ignoreInvisible) return true ;
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            如果不是图片就忽略
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            ...
            if( ! dataAttr || dataAttr == undefined) return true ;
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
