...
var DetailController = function (_Controller) {
    ...
    function DetailController() {
        ...
        downloadApp条事件绑定
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        _this.addListenerToDownloadApp();
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        打开app按钮点击处理
    ...
    _createClass(DetailController, [{
        key: "fiveLine",
        value: function fiveLine() {
            $('.more').hide();
            var rowNum = Math.round($(".base-info").height() / parseFloat($(".base-info").css('line-height')));
            if (rowNum > 5) {
        ...
        value: function echartFun(echartData) {
            ...
            var colorChang = minPrice - avgPrice > 0 || minPrice == 0 ? '#979797' : '#fff';
