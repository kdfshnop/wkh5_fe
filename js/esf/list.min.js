...
var ListController = function (_Controller) {
    ...
    function ListController() {
        ...
        加载相关页面组件逻辑
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        require(["../components/bigdata.min", "../components/filter.min", "../components/async-item.min", "../components/conning-tower.min"], function (BigData, Filter, AsyncItem) {
            BigData.init(_this);
    ...
    _createClass(ListController, [{
        ...
        value: function createHouseItems(data) {
            ...
            <dl>\
                ...
                <dd class="tags"><div class="wk-tags">' + (!item.tagList ? "" : item.tagList.map(function (tag) {
                    switch (tag) {
                        case "降价":
