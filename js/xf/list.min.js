        ...
        value: function createHouseItems(data) {
            ...
            data.forEach(function (item) {
                ...
                <div class="info">\
                    ...
                    <ul class="tags">' + (item.hasActivity == '1' && '<li class="yh">有优惠</li>' || "") + (item.isSubwayEstate == '1' && '<li class="dt">近地铁</li>' || '') + (!item.isSoonOpen == '1' && '<li>在售楼盘</li>' || '<li>即将开盘</li>') + (item.hasVideo == '1' && '<li>有视频</li>' || '') + '</ul>\
