    ...
    _createClass(ListController, [{
        ...
        value: function createHouseItems(data) {
            ...
            data.forEach(function (item) {
                ...
                <div class="img">\
                    <img src="' + item.imageUrl + '">' + (item.hasVideo && '<span class="play"><i></i></span>' || '') + '\
                ...
                <div class="info">\
                    ...
                    <ul class="tags">' + (item.hasActivity && '<li class="yh">有优惠</li>' || "") + (item.isSubwayEstate && '<li class="dt">近地铁</li>' || '') + (!item.isSoonOpen && '<li>在售楼盘</li>' || '<li>即将开盘</li>') + (item.hasVideo && '<li>有视频</li>' || '') + '</ul>\
