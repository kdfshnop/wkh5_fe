    ...
    _createClass(ListController, [{
        ...
        value: function choseFun() {
            ...
            $('.rent-list > ul > li').click(function () {
                ...
                var list = $('.rent-list > ul > li > span'); /*根据span标签的样式判断底部罩层是否显示*/
                $('.bac').hide();
                ...
                var indexP = $(this).index(); /*根据点击li标签的位置判断相应的模块响应出现*/
                if (indexP == 0) {
                    /*判断区域模块的显示*/
                    $('.dic').stop();
                    $('.price-total').hide();
        ...
        key: "dataRender",
        value: function dataRender(apiData) {
            var allDome = '';
