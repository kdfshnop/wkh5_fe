    ...
    function ListController() {
                ...
                if (data.status == 1) {
                        ...
                        if (dataAreasName == "不限") {
                            ...
                            $('#town >li').click(function () {
                                ...
                                if (dataTownName == "不限") {
                                    ...
                                    window.location.href = url + _conditionString; // 跳转的URL
                                } else {
                                    ...
                                    window.location.href = url + _conditionString2; // 跳转的URL
                                }
                                $('.bac').hide();
                                $('#dic').children('span').removeClass('direction');
                                $('#dic').find('i').addClass('bacchosed');
                    ...
                    $('#town >li').click(function () {
                        ...
                        if (dataTownName == "不限") {
                            ...
                            window.location.href = url + _conditionString3; // 跳转的URL
                        }
                        $('.bac').hide();
                        $('#dic').children('span').removeClass('direction');
                        $('#dic').find('i').addClass('bacchosed');
                ...
                if (data.status == 1) {
                    ...
                    $('#metroLine > li').click(function () {
                        ...
                        $('#metroStation > li').click(function () {
                            ...
                            if ($(this).html() == "不限") {
                                ...
                                window.location.href = url + _conditionString4; // 跳转的URL
                            }
                            $('.bac').hide();
                            $('#dic').children('span').removeClass('direction');
                            $('#dic').find('i').addClass('bacchosed');
                    ...
                    $('#metroStation > li').click(function () {
                        ...
                        if ($(this).html() == "不限") {
                            ...
                            window.location.href = url + _conditionString5; // 跳转的URL
                        }
                        $('.bac').hide();
                        $('#dic').children('span').removeClass('direction');
                        $('#dic').find('i').addClass('bacchosed');
        ...
        $('.price-list > ul >li').click(function () {
            ...
            if ($(this).html() == '不限') {
                ...
                window.location.href = url + _conditionString6; // 跳转的URL
            }
        ...
        $('#selfPrConf').click(function () {
            ...
            if (parseInt(lowPr) > parseInt(topPr)) {
                ...
                if (lowPr && topPr) {
                    ...
                    window.location.href = url + _conditionString8; // 跳转的URL
                } else {
                    $('#price>p').html("租金");
                    $('#price').find('i').removeClass('bacchosed');
                    $('#price').removeClass('active-color-top');
                    ...
                    window.location.href = url + _conditionString9; // 跳转的URL
                }
                $('.bac').hide();
                $('#price').children('span').removeClass('direction');
                $('.price-total').slideToggle();
