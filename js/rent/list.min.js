...
var ListController = function (_Controller) {
    ...
    function ListController() {
                ...
                if (data.status == 1) {
                        ...
                        if (dataAreasName == "不限") {
                            ...
                            $('#town >li').click(function () {
                                ...
                                if (dataTownName == "不限") {
                                    ...
                                    window.location.href = url + _conditionString + queryString; // 跳转的URL
                                } else {
                                    ...
                                    window.location.href = url + _conditionString2 + queryString; // 跳转的URL
                                }
                                $('.bac').hide();
                                $('#dic').children('span').removeClass('direction');
                                $('#dic').find('i').addClass('bacchosed');
                    ...
                    $('#town >li').click(function () {
                        ...
                        if (dataTownName == "不限") {
                            ...
                            window.location.href = url + _conditionString3 + queryString; // 跳转的URL
                        }
                        $('.bac').hide();
                        $('#dic').children('span').removeClass('direction');
                        $('#dic').find('i').addClass('bacchosed');
                ...
                if (data.status == 1) {
                    ...
                    $('#metroStation > li').click(function () {
                        ...
                        if ($(this).html() == "不限") {
                            ...
                            window.location.href = url + _conditionString5 + queryString; // 跳转的URL
                        }
                        $('.bac').hide();
                        $('#dic').children('span').removeClass('direction');
                        $('#dic').find('i').addClass('bacchosed');
        ...
        if (condition) {
            ...
            var spaceAreaStart = [{ "start": 0, "end": 50 }, { "start": 50, "end": 70 }, { "start": 70, "end": 90 }, { "start": 90, "end": 110 }, { "start": "110", "end": "130" }, { "start": "130", "end": "150" }, { "start": "150", "end": "0" }];
            conditionData = {
                "cityId": cityid,
                "bedRoomSumLists": [],
                "renovations": [],
