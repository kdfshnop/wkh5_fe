...
var ListController = function (_Controller) {
    ...
    function ListController() {
        ...
        new Location({
            ...
            investmentFlag: function investmentFlag(Flag) {
                if (Flag.investment) {
        ...
        var conditionPath = location.pathname.slice(location.pathname.lastIndexOf('/') + 1, location.pathname.length);
                ...
                if (data.status == 1) {
                    ...
                    $('#dicAreas>li').click(function () {
                        ...
                        if (dataAreasName == "不限") {
                            ...
                            var _locationData = ["不限（智能范围)", "500", "1000", "2000", "5000"];
                            var _locationList = '';
                            _locationData.forEach(function (item, index) {
                                if (index == 0) {
                                    _locationList = "<li data-ne='ne-5000'>" + item + "</li>";
                                } else {
                                    _locationList += "<li data-ne=\"ne-" + item + "\">" + item + "\u7C73</li>";
                                }
                            });
                            if ($(this).html() == "附近") {
                                $('#town').empty().append(_locationList);
                            }
                        } else {
                            dataDic.forEach(function (item) {
                                //
        ...
        $('#moreComf').click(function () {
            ...
            var rentWayString = ''; // 租赁方式 字符串
            var rentWayObj = {}; // 租赁方式 对象
            var tagObj = {}; // 标签对象
            var areaObj = {}; // 面积 对象
            var decorationObj = {}; //
            var areaArray = [];
    ...
    _createClass(ListController, [{
        ...
        value: function firstGivePage(conditionObject) {
            ...
            var taString = "ta-0-ta-0-ta-0-ta-0-ta-0-ta-0";
        ...
        value: function creatRent(conditionObject, channel, item) {
            var houseTag = [];
            var houseTagList = '';
            var commision = '';
            ...
            var bigdata = encodeURIComponent(JSON.stringify({ eventName: '1202039', eventParam: { rent_house_id: item.houseId }, channel: channel || "", type: 2 }));
        ...
        key: "pullload",
        value: function pullload(conditionObject, channel) {
            var self = this;
        ...
        value: function pullData(condition, cityid) {
            ...
            if (condition) {
                ...
                var spaceAreaStart = ["0-50", "50-70", "70-90", "90-110", "110-130", "130-150", "150-200", "200-300", "300-0"];
                conditionData = {
                    "cityId": cityid,
                    "bedRoomSumLists": [],
                    "renovations": [],
