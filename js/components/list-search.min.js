...
define(function () {
    var that = void 0;
    var searchInputClick = function searchInputClick(channelFlag, conditionObject, url, areasLineSting, cityId) {
        var acWordHouseList = ''; // 联想词
        var valueSearch = ''; // 检索搜索框的value值
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        搜索框的点击：
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    判断search板块？后面的参数是什么
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    var checkType = function checkType(type, value) {
        var typeSearch = '';
        if (type == 1) {
