...
define(function () {
    ...
    var selectFun = function selectFun(select) {
        $('.' + select).click(function () {
            ...
            if (JSON.parse(localStorage.getItem('searchTrendHistory'))) {
                $('.history').show();
                var searchHistory = JSON.parse(localStorage.getItem('searchTrendHistory')).reverse();
    ...
    var historyList = function historyList(singleData) {
        var saveLocalStorage = JSON.parse(localStorage.getItem('searchTrendHistory')) ? JSON.parse(localStorage.getItem('searchTrendHistory')) : [];
