            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                _this3.request({
                    ...
                    success: function success(result) {
                        ...
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        if (!$.cookie(_this3.moduleType + "SelectedCityPinyin") && parseInt(result.data.cityId, 10) !== parseInt($("#visitedCityId").val(), 10)) {
        ...
        value: function popCitySelector() {
            ...
            this.request({
                ...
                success: function success(result) {
                    ...
                    if (!$.cookie("locationCityName")) $domesticFrame.append("<span>定位城市</span><a class=\"location-city\">定位失败</a>");else $domesticFrame.append("<span>定位城市</span><a class=\"location-city\" data-cityid=\"" + $.cookie("locationCityId") + "\" data-pinyin=\"" + $.cookie("locationCityPinyin") + "\" data-china=\"" + $.cookie("locationCityChina") + "\">" + $.cookie("locationCityName") + "</a>");
                    ...
                    if (!$.cookie("locationCityName")) $overseasFrame.append("<span>定位城市</span><a class=\"location-city\">定位失败</a>");else $overseasFrame.append("<span>定位城市</span><a class=\"location-city\" data-cityid=\"" + $.cookie("locationCityId") + "\" data-pinyin=\"" + $.cookie("locationCityPinyin") + "\"  data-china=\"" + $.cookie("locationCityChina") + "\">" + $.cookie("locationCityName") + "</a>");
