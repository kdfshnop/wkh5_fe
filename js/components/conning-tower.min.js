...
var ConningTower = function () {
    ...
    _createClass(ConningTower, [{
            ...
            $input.keyup(function () {
                ...
                _this.request({
                    ...
                    success: function success(result) {
                        ...
                        有结果的绘制
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        else _this.renderSearchResult(result.data["secondHouseList"]);
                    }
                });
        ...
        value: function renderSearchResult(items) {
            var _this6 = this;
            ...
            items && items.forEach(function (source) {
                ...
                埋点参数
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                var eventNameMapper = { "xf": "1050011", "esf": "1068014", "rent": "" };
                if (eventNameMapper[_this6.moduleType]) {
                    $li.attr("data-bigdata", encodeURIComponent(JSON.stringify({ "eventName": eventNameMapper[_this6.moduleType], "eventParam": { "choice_content": source.estateDesc } })));
                }
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                其他信息全绑到节点上
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            ...
            $(".substitute-mask .list li").click(function (event) {
                ...
                _this6.searchResultItemClick($item.data());
            });
        }
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
