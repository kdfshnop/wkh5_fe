...
var ConningTower = function () {
    function ConningTower(_ref) {
        var bigDataUtil = _ref.bigDataUtil,
            ...
            _ref$locationCallback = _ref.locationCallback,
            locationCallback = _ref$locationCallback === undefined ? $.noop : _ref$locationCallback;
    ...
    _createClass(ConningTower, [{
        ...
        value: function addEventListener() {
            ...
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$conningTowerCitySelectEntrance.click(function () {
                _this.popCitySelector();
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            未开通及招商场景中切换城市链接点击
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$investmentCitySwitch.click(function () {
                _this.consts.$investment.addClass("hidden").removeClass("visible");
                _this.popCitySelector();
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            点击汉堡菜单弹出子菜单
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$hamburgMenu.click(function () {
                $(document.body).css({ "overflow-y": "hidden" }); //滚动条隐藏
                _this.consts.$navigatorMask.fadeIn(100);
                _this.consts.$navigatorPop.animate({
                    right: 0
                }, 100);
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            点击子菜单遮罩关闭子菜单
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$navigatorMask.click(function () {
                $(document.body).css({ "overflow-y": "auto" }); //如果有滚动条就显示  
                _this.consts.$navigatorMask.fadeOut(100);
                _this.consts.$navigatorPop.animate({
                    right: "-200px"
                }, 100);
            });
            ...
            点击司令塔家搜索返回按钮回退
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$conningTowerBack.click(function () {
                history.back();
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            $(".conning-tower dl dd").click(function () {
                _this.consts.$substituteMask.show(50);
                _this.consts.$searchInputBox.trigger("focus");
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            真搜索区域返回按钮事件监听
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$searchBack.click(function () {
                _this.consts.$substituteMask.hide(50);
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            真搜索区域清除输入图标事件监听
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$clearKeywords.click(function () {
                _this.consts.$searchInputBox.val("").trigger("focus");
                _this.consts.$clearKeywords.hide();
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            清除搜索历史按钮事件监听       
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$clearHistory.click(function () {
                _this.consts.$searchResultList.empty();
                _this.consts.$searchResultListAssistant.hide(100);
                delete window.localStorage[_this.moduleType + "SearchHistory"];
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            pop菜单中的下载APP菜单事件监听
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$appDownload.click(function () {
            ...
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$searchInputBox.on("keyup focus input", function () {
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                取得关键词内容
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                var currentValue = _this.consts.$searchInputBox.val() ? $.trim(_this.consts.$searchInputBox.val()) : "";
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                如果关键词有值，就要显示清除按钮
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                var displayStatus = currentValue ? "block" : "none";
                _this.consts.$clearKeywords.css({ "display": displayStatus });
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                如果关键词没有改变什么也不做
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                if (currentValue && currentValue == _this.consts.$searchInputBox.attr("data-last")) return;else {
                    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    先清除结果
                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                    _this.consts.$searchResultList.empty();
                    ...
                    if (!currentValue) {
                        ...
                        _this.consts.$searchInputBox.attr("data-last", currentValue);
                        return;
                    }
                    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    否则就发起请求
                    ...
                    _this.request({
                        ...
                        requestData: { "key": currentValue, "pageName": paramsMapper[_this.moduleType], "cityId": parseInt(_this.consts.visitedCityId, 10) },
                    ...
                    _this.consts.$searchInputBox.attr("data-last", currentValue); //最后将当前值记录到最后一次搜索关键词里面
                }
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            搜索表单提交相当于点击了第一个搜索结果项并阻止默认表单提交行为
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            this.consts.$searchForm.submit(function (event) {
        ...
        value: function citySelectorEventDelegate() {
            ...
            $(".city-selector .tabs-frame a").click(function (event) {
                _this2.swapCity($(event.currentTarget));
            });
        }
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        对接口拿到的业务开通城市进行处理
        ...
        key: "swapCity",
        value: function swapCity($handler) {
        ...
        value: function location() {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                执行定位回调
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                _this3.locationCallback({ "latitude": latitude, "longitude": longitude });
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                根据经纬度反查城市信息
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                _this3.request({
                    ...
                    success: function success(result) {
                        _this3.states.locationMessage = result.data.cityName;
                        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                        写入几个状态值
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        _this3.states.locationCityId = result.data.cityId;
                        _this3.states.locationCityName = result.data.cityName;
                        _this3.states.locationCityPinyin = result.data.cityPinyin;
                        _this3.states.locationCityChina = result.data.china;
                        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                        城市选择弹层定位城市改写
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        var $locationCity = $(document.createElement("A")).addClass("location-city").attr("data-cityid", _this3.states.locationCityId).attr("data-pinyin", _this3.states.locationCityPinyin).attr("data-china", _this3.states.locationCityChina).text(_this3.states.locationCityName);
                        $locationCity.click(function (event) {
                            _this3.swapCity($(event.currentTarget));
                        });
                        ...
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        if (!$.cookie("selectedCityPinyin") && result.data.cityId != _this3.consts.visitedCityId) {
                            //alert("定位成功！没有用户选择的城市，而且定位城市不同于路由城市，将要直接跳转到定位城市！") ;
                            window.location.href = _this3.combineUrl(result.data.cityPinyin);
                        }
                    }
                });
            }, function (error) {
                _this3.states.locationStage = 2; //标识定位已结束            
                switch (error.code) {
                    case error.PERMISSION_DENIED:
                        // 用户阻止了授权                
                        _this3.states.locationMessage = "定位服务暂未开启";
                        _this3.states.locationFailCause = "PERMISSION_DENIED";
                        _this3.localtionFail(false);
                        break;

                    case error.POSITION_UNAVAILABLE:
                        //定位信息无效
                        _this3.states.locationMessage = "定位失败";
                        _this3.states.locationFailCause = "POSITION_UNAVAILABLE";
                        _this3.localtionFail(true);
                        break;

                    case error.TIMEOUT:
                        //定位超时
                        _this3.states.locationMessage = "定位失败";
                        _this3.states.locationFailCause = "TIMEOUT";
                        _this3.localtionFail(true);
                        break;
                    ...
                    case error.UNKNOWN_ERROR:
                        //其他不可预知的错误  
                        _this3.states.locationMessage = "定位失败";
                        _this3.states.locationFailCause = "UNKNOWN_ERROR";
                        _this3.localtionFail(true);
                        break;
                }
            }, geoOpts);
        ...
        key: "retractCitySelector",
        value: function retractCitySelector() {
            ...
            this.request({
                ...
                success: function success(result) {
                    ...
                    if ($.isEmptyObject(cities.domestic) || $.isEmptyObject(cities.overseas)) {
                        if (!$.isEmptyObject(cities.domestic)) $ul = "<ul class=\"tabs-handle\" style=\"display : none\"><li class=\"on\" data-sign=\"domestic\">国内</li><li data-sign=\"overseas\">国际</li></ul>";else $ul = "<ul class=\"tabs-handle\" style=\"display : none\"><li data-sign=\"domestic\">国内</li><li class=\"on\" data-sign=\"overseas\">国际</li></ul>";
                    }
                    $(".city-selector .caption").append($ul);
                    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    绘制tabs-frame
                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                    var $status = _this4.states.locationStage == 2 && !_this4.states.locationFailCause && _this4.states.locationCityName ? "<a class=\"location-city\" data-cityid=\"" + _this4.states.locationCityId + "\" data-pinyin=\"" + _this4.states.locationCityPinyin + "\" data-china=\"" + _this4.states.locationCityChina + "\">" + _this4.states.locationCityName + "</a>" : "<a class=\"location-city\">" + _this4.states.locationMessage + "</a>";
                    ...
                    _this4.consts.$citySelector.append($domesticFrame);
                    ...
                    _this4.consts.$citySelector.append($overseasFrame);
                    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    最后给dom节点绑定事件
                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        ...
        key: "localtionFail",
        value: function localtionFail(tips) {
            var _this5 = this;
            ...
            if ($.cookie("selectedCityPinyin")) {
                ...
                if (!tips) this.popCitySelector();else {
                    $.modal({
        ...
        value: function renderSearchResult(_ref3) {
            ...
            items && items.forEach(function (source) {
                ...
                _this6.consts.$searchResultList.append($li);
            });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        key: "detectSearchResultClick",
        value: function detectSearchResultClick() {
            var urlArray = window.location.href.split("/");
            var paramObj = ParamGenerator.queryString2Object(urlArray[5]);
