    ...
    _createClass(ConningTower, [{
        ...
        value: function citySelectorEventDelegate() {
            ...
            $(".city-selector .tabs-frame a").click(function (event) {
                ...
                _this2.cityClick();
                _this2.retractCitySelector();
                if ($handler.data("cityid") != _this2.consts.visitedCityId) window.location.href = _this2.combineUrl($handler.data("pinyin"));
            });
        }
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        对接口拿到的业务开通城市进行处理
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                _this3.request({
                    ...
                    success: function success(result) {
                        ...
                        城市选择弹层定位城市改写
                        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        $(".city-selector .tabs-frame .location-city").replaceWith("<a class=\"location-city\" data-cityid=\"" + _this3.states.locationCityId + "\" data-pinyin=\"" + _this3.states.locationCityPinyin + "\" data-china=\"" + _this3.states.locationCityChina + "\">" + _this3.states.locationCityName + "</a>");
                        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
