...
(function ($) {
    ...
    return this.each(function () {
      ...
      if (opts.fixedWhenScroll) {
        $(window).scroll(function () {
          ...
          if ($(window).scrollTop() >= $tabsHandle.height()) $tabsHandle.css({ "position": "fixed", "width": "100%", "left": 0, "top": 0 });else $tabsHandle.css({ "position": "static" });
        });
      }
    });
  };
  ...
  $.fn.tabs.swapTo = function (tabs, index, opts) {
    ...
    if (opts.duration == "normal" || opts.duration == "fast" || opts.duration == "slow") eval("$(tabs).find('.' + opts.frameClass).eq(index)." + opts.effect + "('" + opts.duration + "')");else eval("$(tabs).find('.' + opts.frameClass).eq(index)." + opts.effect + "(" + opts.duration + ")");
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    调用接口事件
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
