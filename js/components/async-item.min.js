...
var AsyncItem = function () {
    function AsyncItem(_ref) {
        var controller = _ref.controller;

        _classCallCheck(this, AsyncItem);
    ...
    _createClass(AsyncItem, [{
        key: "xf",
        value: function xf(item) {
            var result = "<a class=\"xf-item\" href=\"" + item.url + "\" data-bigdata=\"" + item.bigDataParams + "\">";
            ...
            if (item.isSoonOpen == "1") result += "<div><span>即将开盘</span></div>";else result += "<div><span>在售楼盘</span></div>";
            result += "</div>";
            result += "<p class=\"unit-price\">";
            var className = item.avgPriceWou == '0' ? "normal" : "";
            var avgPriceWou = item.avgPriceWou == '0' ? "价格待定" : item.avgPriceWou;
        ...
        key: "esf",
        value: function esf(item) {
            var result = "<a href=\"" + item.url + "\" class=\"esf-item\" data-bigdata=\"" + item.bigDataParams + "\">";
            result += "<dl><dt>";
            ...
            item.tagList && item.tagList.forEach(function (tag) {
                if (tag == "降价") result += "<div class=\"highlight promotion\"><span>" + tag + "</span></div>";else if (tag == "新上") result += "<div class=\"highlight new\"><span>" + tag + "</span></div>";else if (tag == "满二" || tag == "满五唯一") result += "<div class=\"highlight over\"><span>" + tag + "</span></div>";else result += "<div><span>" + tag + "</span></div> ";
            });
            result += "</div></dd>";
        ...
        key: "rent",
        value: function rent(item) {
            var result = "<a data-bigdata=\"" + item.bigDataParams + "\" class=\"rent-item box\" href=\"" + item.url + "\">";
...
//# sourceMappingURL=async-item.min.js.map
