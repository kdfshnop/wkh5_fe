...
var IndexController = function (_Controller) {
    ...
    function IndexController() {
        ...
        var self = _this;
        var locationPo = {
            longitude: _this.getLocation().longitude,
            latitude: _this.getLocation().latitude
        };
        console.log(locationPo);
        _this.request(_this.apiUrl.store.house, { "storeId": $("#storeId").val(), "pageIndex": 0, 'pageSize': 20, lon: locationPo.longitude, lat: locationPo.latitude }, {
