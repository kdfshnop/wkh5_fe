...
var IndexController = function (_Controller) {
    ...
    function IndexController() {
        ...
        定位加载实例化
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        _this.getLocation(function (locationPo) {
            _this.getHoustList({ "latitude": locationPo.latitude, "longitude": locationPo.longitude });
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
             上拉加载实例化
             -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
            _this.pullload(locationPo.latitude, locationPo.longitude);
        });
    ...
    _createClass(IndexController, [{
        ...
        value: function createEsf(esf) {
            ...
            var tagNode = $(document.createElement("DD")).addClass("tags");
            esf.tagList && esf.tagList.forEach(function (tag) {
                if (tag == "降价") {
        ...
        上拉加载实例化
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        value: function pullload(latitude, longitude) {
            var self = this;
            //二手房
            $(".tabs-frame.esf-items .list-container").pullload({
                ...
                callback: function callback(data) {
                    if (!data.data) return;
                    $.each(data.data, function (index, esf) {
        ...
        请求房源数据
        -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        value: function getHoustList(position) {
            var self = this;
