...
var Pagination = function () {
    ...
    _createClass(Pagination, [{
        ...
        key: "genPageNumber",
        value: function genPageNumber(pageIndex, totalCount) {
            var _this = this;
...
(function ($) {
    ...
    Plugin.prototype = {
        ...
        //进度条
        animateProgressBarPosition: function animateProgressBarPosition() {
            var self = this,
        ...
        //获取时间秒
        getAudioSeconds: function getAudioSeconds(string) {
            var self = this,
                string = string % 60;
        ...
        //获取时间分
        getAudioMinutes: function getAudioMinutes(string) {
            var self = this,
                string = string / 60;
            string = self.addZero(Math.floor(string), 2);
            string < 60 ? string = string : string = "00";
        ...
        //时间+0
        addZero: function addZero(word, howManyZero) {
            var word = String(word);
            // while (word.length < howManyZero) word = "0" + word;
            return word;
        },
        //更新总时间
        updateTotalTime: function updateTotalTime(time) {
            var self = this,
        ...
        //改变音频源
        changeSrc: function changeSrc(src, callback) {
            var self = this;
            self.pause();
            self.Audio.src = src;
            self.play();
...
var ArticleShareController = function (_Controller) {
    _inherits(ArticleShareController, _Controller);

    function ArticleShareController(opts) {
        _classCallCheck(this, ArticleShareController);

        // 设置参数
        var _this2 = _possibleConstructorReturn(this, (ArticleShareController.__proto__ || Object.getPrototypeOf(ArticleShareController)).call(this));

        _this2.setOptions(opts);
        _this2.setArticleFont();
        // 初始化操作
        _this2.Operation = Operation;
        _this2.articleId = $.trim($('#articleId').val());
        _this2.cityId = $.trim($('#cityId').val());
        // 初始化评论列表
        _this2.refreshComment();
        // 绑定事件
        _this2.bindEvent();
        _this2.convertLink();
        _this2.convertVideo();
        ...
        _this2.textareaHeight = $('.commentArea').find('textarea').height();
        _this2.wkBigDataParams = {
            pageName: 1022,
            pageParam: {
                article_id: _this2.articleId
            },
            eventName: '',
            eventParam: {},
            nextPageName: '',
    ...
    _createClass(ArticleShareController, [{
        key: "initWxShare",
        ...
        key: "getQueryString",
        value: function getQueryString(params, name) {
        ...
        key: "createCommentList",
        value: function createCommentList(result) {
            var html = [];
