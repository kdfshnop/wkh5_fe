...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
var townController = function (_Controller) {
    _inherits(townController, _Controller);

    function townController() {
        _classCallCheck(this, townController);

        var _this = _possibleConstructorReturn(this, (townController.__proto__ || Object.getPrototypeOf(townController)).call(this));
    ...
    _createClass(townController, [{
        ...
        value: function echartFun(echartData) {
            ...
            var minPrice = null; //Math.ceil((sortArray[0] / 1000) - 1) * 1000;
