...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
var communityController = function (_Controller) {
    _inherits(communityController, _Controller);

    function communityController() {
        _classCallCheck(this, communityController);

        var _this = _possibleConstructorReturn(this, (communityController.__proto__ || Object.getPrototypeOf(communityController)).call(this));
    ...
    _createClass(communityController, [{
        key: "echartFun",
