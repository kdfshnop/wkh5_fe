...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
var cityController = function (_Controller) {
    _inherits(cityController, _Controller);

    function cityController() {
        _classCallCheck(this, cityController);

        var _this = _possibleConstructorReturn(this, (cityController.__proto__ || Object.getPrototypeOf(cityController)).call(this));
