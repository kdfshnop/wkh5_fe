...
var Location = function () {
    ...
    _createClass(Location, [{
        ...
        value: function timeout() {
            ...
            $.modal({
                ...
                "buttons": [{ "text": "去选择", "className": "goto-select-city", "clickCallback": function clickCallback() {
                        ...
                        window.location.href = "/public/city/select?businessType=" + _this3.businessType;
                    } }]
            });
        }
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        value: function route(newPinyin, newCityId) {
            ...
            var moduleName = "esf";
            if (this.businessType === "new") moduleName = "xflist";else if (this.businessType === "rent") moduleName = "rent/?channel=jrttsub";
