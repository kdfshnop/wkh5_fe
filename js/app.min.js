                ...
                _this.request(_this.apiUrl.common.dial, { agentId: $("#agentId").val(), houseId: $("#houseId").val(), serviceType: $("#serviceType").val() }, {
                    successCallback: function successCallback(result) {
                        $.modal({
                            ...
                            "content": "<p><span class=\"name\">" + $(".assistant .portrait .right .name").html() + "</span> <span class=\"company\">" + $(".assistant .portrait .right .company-name").html() + "</span></p><p class=\"tel\">" + "4008208907" + "</p><p class=\"memo\">为了保护您的隐私， 已为您隐藏手机号码您可安心拨打</p>",
                            "buttons": [{ "text": "取消", "clickCallback": function clickCallback() {
                                    $.modal.close("callAgentModal");
                                } }, { "text": "拨打", "className": "phone", "href": "tel:" + "4008208907" }]
                        });
                    }
                });
            });
                    ...
                    success: function success(result) {
                        ...
                        if (result.status.toString() === "1" && city) {
                            ...
                            if (city.cityId == $.cookie("cityId")) {
                                ...
                                如果不同，就组织新的路由跳转
                                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                                var newCityId = city[_this2.businessType + "Business"] ? city.cityId : 43;
                                var newPinyin = city[_this2.businessType + "Business"] ? city.cityPinyin : "shanghai";
                                window.location.href = _this2.route(newPinyin, newCityId);
                            }
                        } else {
                            if (!($.cookie("cityId") == 43)) {
                                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
