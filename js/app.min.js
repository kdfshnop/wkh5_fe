    ...
    _createClass(Location, [{
        ...
        value: function orientate() {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                往cookie里面写经纬度
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                $.cookie(_this.cookieKeyPrefix + "latitude", latitude);
                $.cookie(_this.cookieKeyPrefix + "longitude", longitude);
                /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
                根据经纬度反查城市信息
                -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                $.ajax({
                    ...
                    success: function success(result) {
                        ...
                        if (result.status.toString() === "1") {
                            ...
                            写几个cookie的值
                            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                            $.cookie(_this.cookieKeyPrefix + "cityName", city.cityName);
                            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        value: function route(newPinyin, newCityId) {
            ...
            var moduleName = "esf";
            if (this.businessType === "new") moduleName = "xflist";else if (this.businessType === "rent") moduleName = "rent";
