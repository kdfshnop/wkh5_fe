...
var Controller = function () {
    ...
    _createClass(Controller, [{
        ...
        value: function request(apiUrl, data, params) {
            ...
            var process = params.process || $.noop;
            var showLoadingTips = params.showLoadingTips || true;
            ...
            if (apiDataType === "jsonp") options.jsonpCallback = "callback" + new Date().getTime(); //这个地方必须随机，否则重复执行这个请求会报这个参数值不是个方法
            try {
                $.ajax(options);
            } catch (e) {
