                    ...
                    successCallback: function successCallback(result) {
                        $.modal({
                            ...
                            "buttons": [{ "text": "取消", "clickCallback": function clickCallback() {
                                ...
                                } }, { "text": "拨打", "className": "phone", "clickCallback": function clickCallback() {
...
var Location = function () {
    function Location(_ref) {
        ...
        if (window.navigator.cookieEnabled) {
            var latitude = $.cookie(this.cookieKeyPrefix + "latitude") || "";
            var longitude = $.cookie(this.cookieKeyPrefix + "longitude") || "";
            /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------            
    ...
    _createClass(Location, [{
        ...
        value: function orientate() {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                _this.success(_this.coordinates);
            }, function (error) {
                switch (error.code) {
