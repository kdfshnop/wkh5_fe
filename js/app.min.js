...
var WakeupApp = function () {
    function WakeupApp(_ref) {
        var element = _ref.element,
            androidSchemes = _ref.androidSchemes,
    ...
    _createClass(WakeupApp, [{
        ...
        value: function bindEvent() {
            ...
            $(this.opts.element).click(function () {
                if (_this.system() === "wechat") {
                    top.window.location = _this.opts.androidDownloadLink;
                    return;
                }
                _this.openDownloadLink();
                _this.isHasApp();
            });
        }
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        value: function openDownloadLink() {
            ...
            window.setTimeout(function () {
                var system = _this2.system();
                var downloadUrl = "";
                if (system === "ios") downloadUrl = _this2.opts.iosDownloadLink;else if (system === "android") downloadUrl = _this2.opts.androidDownloadLink;
                if (!_this2.hasApp) {
