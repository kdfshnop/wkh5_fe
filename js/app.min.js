...
ParamGenerator.convert2FilterParam = function (obj) {
    ...
    }, _defineProperty(_funcs, 'ht', ParamGenerator.createMappingFunc(2, "houseTypes.decorations")), _defineProperty(_funcs, 'ag', ParamGenerator.createMappingFunc(2, "houseTypes.houseAges")), _defineProperty(_funcs, 'ar', ParamGenerator.createMappingFunc(2, "houseTypes.ares")), _defineProperty(_funcs, 'lon', ParamGenerator.createMappingFunc(1, "longitude")), _defineProperty(_funcs, 'lat', ParamGenerator.createMappingFunc(1, "latitude")), _funcs);
